<?php 
	...
	if($formModifierPile == 1){
		...
		while($liste = mysql_fetch_assoc($req)) 	{
			$formDate     = isset($_POST[$liste['id_motif']."_".$liste['id_patient']."_date"])     ? $_POST[$liste['id_motif']."_".$liste['id_patient']."_date"]     : '';
			$formStatut   = isset($_POST[$liste['id_motif']."_".$liste['id_patient']."_statut"])   ? $_POST[$liste['id_motif']."_".$liste['id_patient']."_statut"]   : '';
						...
						<fieldset class=''>
							<legend>Liste de contacts</legend>
								...
								if(mysql_num_rows($result)!=0) {
									...
									echo"<tr>";
									echo"<div id='details_entree_".$data['id_motif']."_".$data['id_patient']."' style='display:none'>";
							?>  
									 <table id='info'>
										<tr>
