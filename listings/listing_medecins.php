<?php 
	...
	while($data = mysql_fetch_assoc($result)) 	{
		...
		$tabMedecin[floor($i/10)] .= "<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?medecin_inami=".$data['inami']."'>".$data['nom']." ".$data['prenom']."</a></li>";
	...
	while($data = mysql_fetch_assoc($result)) 	{
		...
		$tabMutuelle[floor($i/10)] .= "<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?mutuelle_code=".$data['code']."'>".$data['code']." ".$data['nom']."</a></li>";
...
<body id='body'>
   ...
   <?php
		...
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?medecin_inami=all'>Tous les m&eacute;decins</a></li>";
		echo "							</ul>";
		echo "						</div>";
		echo "					</div>";
		echo "				</li>";
		...
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?mutuelle_code=all'>Toutes les mutuelles</a></li>";
		echo "							</ul>";
		echo "						</div>";
		echo "					</div>";
		echo "				</li>";
		...
		echo "						<div class='bd'>";
		echo "							<ul class='first-of-type'>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?periode=day'>Journ&eacute;e</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?periode=first'>Premi&egrave;re quinzaine</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?periode=second'>Deuxi&egrave;me quinzaine</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?periode=month'>Mois</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='listing_medecins.php?periode=all'>Complet</a></li>";
		echo "							</ul>";
		echo "						</div>";
		echo "					</div>";
		echo "				</li>";
    ...
    <div id="top">
		...
		<h1>
 			Facturation aux m&eacute;decins : <?=$listingTitle?>
		</h1>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
    				...
    				<span>Facturation aux  m&eacute;decins</span> 
				...
				<div class="View">
					...
					<div class="navigation-hight">
						...
						<div class="navigation-calendar">
							...
							<a class="previousMajor" href="./listing_medecins.php?action=previous_month" onclick="" title="Mois pr&eacute;c&eacute;dent"></a>
							<a class="previousMinor" href="./listing_medecins.php?action=previous_day" onclick="" title="Jour pr&eacute;c&eacute;dent"></a>
							<a class="nextMajor" href="./listing_medecins.php?action=next_month" onclick="" title="Mois suivant"></a>
							<a class="nextMinor" href="./listing_medecins.php?action=next_day" onclick="" title="Jour suivant"></a>
