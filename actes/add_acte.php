<?php 
	...
	if ($actionAddActe == 1) {
		...
		$test->stringtest($formCoutSM,"cout_sm","co&ucirc;t sans mutuelle");
		
		// Traitement lorsque tous les tests sont passés avec succès
		if ($test->Count == 0) {
    	
			$q = requete_SQL ("INSERT INTO actes (code,description,cecodis,cout_vp,cout_tr,cout_tp,cout_sm,length) VALUES ('$formCode','$formDescription','$formCecodis','$formCoutVP','$formCoutTR','$formCoutTP','$formCoutSM','$formLength')");
