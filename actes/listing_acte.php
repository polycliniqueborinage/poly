<?php 
	...
	$sqlglobal= "select concat('$modif1',id,'$modif2'), code, description, cecodis, cout_tr, cout_tp, cout_vp, cout_sm, length FROM actes order by description";
					...
					<div id="secondmain" >
						...
						<table id="ex50" class="ricoLiveGrid" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<th>Co&ucirc;t Sans Mutuelle</th>
								<th>Dur&eacute;e</th>
	  						</tr>
						</table>						
