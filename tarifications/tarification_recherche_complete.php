<?php 
	...
	if(mysql_num_rows($result)>0) {
		...
		if ($_SESSION['role'] == 'Administrateur') {
			echo "<th class='td'  colspan='9' align='center'>";
			echo "Actions";
			echo "</th>";
		} else {
		...
		while($data = mysql_fetch_assoc($result)) 	{
			...
			if ($_SESSION['role'] == 'Administrateur') {
				...
				echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'>";
				echo "<a href='#' onClick='";
				echo "openDialogConfirmDelTarification(\"$utilisation\",$id)";
				echo ";return false;'>";
				echo "<img width='16' height='16' src='../images/delete_small.gif' alt='Effacer' title='Effacer' border='0' /></a>";
				echo "</td>";
				
				// 2 )DeCloture
				if ($etat == 'close' || $etat =='closepaye' || $etat =='closeerrpatient'){
					echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'>";
					echo "<a href='#' onClick='";
					echo "tarificationAction(\"$utilisation\",\"decloture_tarification\",$id)";
					echo ";return false;'>";
					echo "<img width='16' height='16' src='../images/16x16/arrow_refresh.png' alt='D&eacute;cl&ocirc;turer la tarification' title='D&eacute;cl&ocirc;turer la tarification' border='0' /></a>";
					echo "</td>";
				} else {
				...
				if ($etat == 'close'){
					...
					echo ";return false;'>";
					echo "<img width='16' height='16' src='../images/16x16/user_delete.png' alt='Cl&ocirc;turer un non paiement par un patient' title='Cl&ocirc;turer un non paiement par un patient' border='0' /></a>";
					echo "</td>";
				} else {
					echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'></td>";
				}
				...
				if ($etat == 'closeerrpatient'){
					...
					echo ";return false;'>";
					echo "<img width='16' height='16' src='../images/16x16/user_add.png' alt='D&eacute;cl&ocirc;turer un non paiement par un patient' title='D&eacute;cl&ocirc;turer un non paiement par un patient' border='0' /></a>";
					echo "</td>";
				} else {
					echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'></td>";
				}
				...
				if ($etat == 'close'){
					...
					echo ";return false;'>";
					echo "<img width='16' height='16' src='../images/16x16/pill_delete.png' alt='Cl&ocirc;turer une erreur du m&eacute;decin' title='Cl&ocirc;turer une erreur du m&eacute;decin' border='0' /></a>";
					echo "</td>";
				} else {
					echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'></td>";
				}
				...
				if ($etat == 'close'){
					...
					echo ";return false;'>";
					echo "<img width='16' height='16' src='../images/16x16/ruby_delete.png' alt='Renoncer au paiement &agrave; la polyclinique' title='Renoncer au paiement &agrave; la polyclinique' border='0' /></a>";
					echo "</td>";
				} else {
					echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'></td>";
				}
				...
				if ($etat == 'close'){
					...
					echo ";return false;'>";
					echo "<img width='16' height='16' src='../images/16x16/money_delete.png' alt='Cl&ocirc;turer une erreur de caisse' title='Cl&ocirc;turer une erreur de caisse' border='0' /></a>";
					echo "</td>";
				} else {
					echo "<td width='16' align='center' valign=top' bgcolor='#D5D5D5'></td>";
				}
			...
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>$id</td>";
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>".$data['tarification_date']."</td>";
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>".htmlentities(stripcslashes($data['patient_nom']),ENT_QUOTES)." ".htmlentities(stripcslashes($data['patient_prenom']),ENT_QUOTES)."</td>";
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>$dico[$type]</td>";
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>".htmlentities(stripcslashes($data['medecin_nom']),ENT_QUOTES)." ".htmlentities(stripcslashes($data['medecin_prenom']),ENT_QUOTES)."</td>";
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>".$solde."</td>";
			echo "<td valign='top' bgcolor='#D5D5D5' nowrap='nowrap' onclick='javascript:tarificationRechercheCompleteList($id,\"$utilisation\",\"$limit\")'>".$cloture."</td>";
