...
<head>
	<title>Poly - Listing des tarifications encours</title>
...
<body id='body'>
	...
	<div id="top">
		...
		<h1 class="tarification">Tarifications - Listing des tarifications encours</h1>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
					...
					<a href="./listing_tarification_day.php">Tarification du jour</a>
      					
					<span>Tarification encours</span> 
				...
				<div class="listViewPane">
					...
					<div class="navigation-hight">
						...
						<div id='formhelp'>
							Liste de toutes les tarifications encod&eacute;es mais non cl&ocirc;tur&eacute;es ou non pay&eacute;es.<br />
						</div>
						<div id='formmodif'>
						</div>
