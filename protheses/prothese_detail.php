<?
	...
	$sql = "SELECT id, date, caisse, medecin_inami, patient_id, mutuelle_code, patient_matricule, titulaire_matricule, type, ct1, ct2, tiers_payant, children, age, sex, etat, a_payer, paye, log FROM tarifications WHERE id='$urlID' and utilisation = 'prothese'";
	...
	$sql = "SELECT id, prothese_id, date, type, montant FROM protheses_detail WHERE (prothese_id = '$urlID' AND type = 'cout_totale') order by 3";
	$result = requete_SQL ($sql);
	if(mysql_num_rows($result)!=0) {
	...
	$sql = "SELECT sum(montant) as somme FROM protheses_detail WHERE (prothese_id = '$urlID' AND type = 'cout_totale')";
	$result = requete_SQL ($sql);
	$data = mysql_fetch_assoc($result);
	...
	$sql = "SELECT id, prothese_id, date, type, montant FROM protheses_detail WHERE (prothese_id = '$urlID' AND type = 'cout_prothese') order by 3";
	$result = requete_SQL ($sql);
	if(mysql_num_rows($result)!=0) {
	...
	$sql = "SELECT sum(montant) as somme FROM protheses_detail WHERE (prothese_id = '$urlID' AND type = 'cout_prothese')";
	$result = requete_SQL ($sql);
	$data = mysql_fetch_assoc($result);
	...
	$sql = "SELECT id, prothese_id, date, type, montant, compte FROM protheses_detail WHERE (prothese_id = '$urlID' AND type = 'paiement') order by 3";
	$result = requete_SQL ($sql);
	if(mysql_num_rows($result)!=0) {
	...
	$sql = "SELECT sum(montant) as somme FROM protheses_detail WHERE (prothese_id = '$urlID' AND type = 'paiement')";
	$result = requete_SQL ($sql);
	$data = mysql_fetch_assoc($result);
	...
	$sql = "SELECT cout, cout_mutuelle FROM tarifications_detail WHERE (tarification_id = '$urlID')";
	$result = requete_SQL ($sql);
	if(mysql_num_rows($result)!=0) {
		...
		$remboursementDetail .= "</table>";
	}
	
	$sql = "SELECT sum(cout) as cout_total, sum(cout_mutuelle) as cout_mutuelle_total FROM tarifications_detail WHERE (tarification_id = '$urlID')";
	$result = requete_SQL ($sql);
	$data = mysql_fetch_assoc($result);
	...
	echo "<h1>".$prothesiste."</h1>";
	
	echo $prothesisteDetail;

	echo "<h1>".$acompte."</h1>";
	
	echo $acompteDetail;
	
	echo "<h1>".$remboursement."</h1>";
	
	echo $remboursementDetail;
