...
<body id='body'>
	...
	<div id="top">
		...
		<h1 class="tarification">Anomalies - Recherche d'une anomalie</h1>
				...
				<form name='searchForm' id='searchForm' method='post' action='<?=$nom_fichier?>'>
					...
					<div class="listViewPane">
						...
						<div class="navigation-hight">
							...
							<div id='formhelp'>
								Ce formulaire permet de rechercher une anomalie.<br />
							</div>
							<div id='formmodif'>
							</div>
								...
								<tbody>
									<tr>
										<th class="green patient">
											Patient : <input type='text' id='patient_input' size='32' maxlength='32' class='txtField' title='patient' autocomplete='off'  onKeyUp="javascript:$('prestation_input').value='';$('tarification_input').value='';anomalieRechercheComplete();" />
										</th>
										<th class="green medecin">
											M&eacute;decin : <input type='text' id='medecin_input' size='32' maxlength='32' class='txtField' title='m&eacute;decin' autocomplete='off'  onKeyUp="javascript:$('prestation_input').value='';$('tarification_input').value='';anomalieRechercheComplete();" />
										</th>
									</tr>
									<tr>
										<th class="green">
											Date de d&eacute;but : <input type='text' id='start_date_input' size='32' maxlength='32' class='txtField' title='Recherche du patient' autocomplete='off' onkeyup="javascript:$('prestation_input').value='';$('tarification_input').value='';dateFirstExecutionresult = checkDate(this, '', '');anomalieRechercheComplete();" />
										</th>
										<th class="green">
											Date de fin : <input type='text' id='end_date_input' size='32' maxlength='32' class='txtField' title='Recherche du m&eacute;decin' autocomplete='off'  onKeyUp="javascript:$('prestation_input').value='';$('tarification_input').value='';dateFirstExecutionresult = checkDate(this, '', '');anomalieRechercheComplete();" />
										</th>
									</tr>
									<tr>
										<th class="green">
											Identifiant prestation : <input type='text' id='prestation_input' size='32' maxlength='32' class='txtField' title='Identifiant prestation' autocomplete='off' onkeyup="javascript:$('tarification_input').value='';tarification_number = checkNumber(this, tarification_number, 20, false);anomalieRechercheComplete();" />
																	 <input type='hidden' id='tarification_input' />
										</th>
										<th class="green">
											Status : 
											<select id='etat_input' title='Status tarification' onchange="javascript:$('prestation_input').value='';$('tarification_input').value='';anomalieRechercheComplete();">
												<option value=''>Toutes les anomalies</option>
												<option value="AND (a.etat = 'close')">Anomalies clotur&eacute;es</option>
											</select>
										</th>
										<!-- th class="green">
											Identifiant prestation : <input type='text' id='prestation_input' size='32' maxlength='32' class='txtField' title='Identifiant prestation' autocomplete='off'  onKeyUp="javascript:prestation_number = checkNumber(this, prestation_number, 20, false);anomalieRechercheComplete();" />
										</th-->
									</tr>
									<tr>
