<?php 
	...
	if(mysql_num_rows($result)==1) {
		...
		while($data = mysql_fetch_assoc($result)) 	{
			...
			$content .= "<b><a href='#' onClick='javascript:tarificationCheckCecodiPopUpList($dataCecodi);return false;' >".$dataCecodi."</a></b> - ".htmlentities($dataDescription)." - <font color = 'red'>Age = ".$age."</font>".$dataTpfortr."<br/>";
