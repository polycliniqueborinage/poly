<?php 
	...
	$nom_fichier = "recherche_mutuelle.php";
...
<head>
	<title>Poly - Modification des mutuelles</title>
...
<body id='body'>
   ...
   <?php
    ...
    <div id="top">
		...
		<h1>Mutuelles - Reherche d'une mutuelle</h1>
				...
				<div class="secondary_tabs">
					...
					<div class="listViewPane">
						...
						<div class="navigation-hight">
							...
							<div id='formhelp'>
								Ce formulaire permet de rechercher et de modifier une mutuelle &agrave; condition que celle-ci existe d&eacute;j&agrave; dans l'application.<br />
							</div>
						<div id='formmodif'>
						</div>
						...
						<div id='Box'>
							<table cellspacing="1" cellpadding="1">
								<tbody>
									<tr>
										<th class="green">
											Recherche : <input type='text' name='pseudo' id='pseudo' size='40' maxlength='32' class='txtField' title='Nom ou code de la mutuelle' value='' onKeyUp='mutuelleRechercheComplete(this.value);' autocomplete='off' />
										</th>
									</tr>
									<tr>
										<td colspan='2' class='texte' id='mutuelleBox'>
										</td>
									</tr>
								</tbody>
							</table>
			...
			new Ajax.Request('../mutuelles/mutuelle_action.php',
				{
					...
					requestHeaders: {Accept: 'application/json'},
			  		onSuccess: function(transport, json){
			  			...
			  			Dialog.confirm("<table><tr><td><img src='../images/96x96/help.png'></td><td>Etes-vous certain de vouloir <b>supprimer</b> la mutuelle suivante : <br><br>"+comment+"<td/><tr/><table/>", {width:400, height:200, top:50, okLabel: "OUI", cancelLabel: "Annuler", className: "alphacube", buttonClass: "myButtonClass", id: "myDialogId", cancel:function(win) {return false;}, ok:function(win) {mutuelleAction('del_mutuelle',id,'',''); return true;} });
		    	    },
