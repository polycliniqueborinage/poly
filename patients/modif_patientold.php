	...
	if ($modifPatient == 1) {
		...
		if (isset($_GET['id'])) {
			...
			if($n==1) {
				...
				//Récuperation de la mutuelle de la DB du patient
				...
				//Récuperation des variables de la DB du titulaire
			...
			<div id="tab_panel">
				...
				<div class="ViewPane">
					...
					<div class="navigation-hight">
						...
						<div id='formhelp'>
							Ce formulaire permet de modifier un patient titulaire ou non de sa mutuelle. <font color="red"><b>Attention, le titulaire doit être correctement encodé (code mutuelle, CT1/CT2...).</b></font>
						</div>
