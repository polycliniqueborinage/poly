<?php
	...
	$nom_fichier = "line_statistique.php";
...
<body id='body' class="yui-skin-sam">
   ...
   <?php
	    	...
	    	<tr>
    	    	...
    	    	<td class="drawer-content">
					...
					<div id="labels" class="sidebar labels-red">
						...
						<select id='statistique' name='statistique' width="179" style="width: 179px" onClick="document.getElementById('number').style.pixelWidth = 179" onchange="javascript:loadLineStatistique('stat_statistique',this.value);">
							<option value='COUNT(td.id)'>% de prestations</option>
							<option value='SUM(td.cout_mutuelle)'>% rentr&eacute;e totale</option>
							<option value='SUM(td.cout_medecin)'>% rentr&eacute;e m&eacute;decin</option>
							<option value='SUM(td.cout_poly)'>% rentr&eacute;e polyclinique</option>
						</select>
					...
					<div id="labels" class="sidebar labels-red">
						...
						<select id='groupe' name='groupe' width="179" style="width: 179px" onClick="document.getElementById('number').style.pixelWidth = 179" onchange="javascript:loadLineStatistique('stat_groupe',this.value);">
					...
					<div id="labels" class="sidebar labels-red">
						...
						<select id='number' name='number' width="179" style="width: 179px" onClick="document.getElementById('number').style.pixelWidth = 179" onchange="javascript:loadLineStatistique('stat_statistique_number',this.value);">
	...
	<script type="text/javascript">  
		...
		loadLineStatistique('empty','empty');
...
<script type="text/javascript">
	...
	YAHOO.start.calendar.init = function() {
		function handleSelect(type,args,obj) {
			...
			loadLineStatistique('stat_date_min',year + "-" + month + "-" + day);
		}
	...
	YAHOO.end.calendar.init = function() {
		function handleSelect(type,args,obj) {
			...
			loadLineStatistique('stat_date_max',year + "-" + month + "-" + day);
