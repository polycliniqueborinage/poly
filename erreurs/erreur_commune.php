<?php 
	...
	$nom_fichier = "erreur_commune.php";
	...
	$listingTitle = "";
	$sqlglobal= "select ta.id as id, DATE_FORMAT(ta.date, GET_FORMAT(DATE, 'EUR')) as tarification_date, pa.nom as patient_nom, pa.prenom as patient_prenom, me.nom as medecin_nom, me.prenom as medecin_prenom, er.a_payer as a_payer, er.caisse as caisse  FROM erreurs er, patients pa, medecins me, tarifications ta WHERE er.type = 'erreur_commune' AND ta.medecin_inami = me.inami and ta.patient_id = pa.id and er.tarification_id = ta.id";
	
 	if ($caisse!='all') {
		$sqlglobal .= " and er.caisse = '".$caisse."'";
 	}
	...
	switch($periode) {
		case 'day':
			...
			$impression_url = "../factures/print_erreur_commune.php?id=day";
		...
		case 'first':
			...
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_commune.php?id=first";
		...
		case 'second':
			...
			$sqlglobal .= " and ta.date >= '".$annee."-".$mois."-16'";
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_commune.php?id=second";
		...
		case 'month':
			...
			$sqlglobal .= " and ta.date >= '".$annee."-".$mois."-01'";
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_commune.php?id=month";
			$listingTitle .= " Mois";
		break;
		case 'all':
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_commune.php?id=all";
...
<body id='body'>
   ...
   <?php
		...
		echo "						<div class='bd'>";
		echo "							<ul class='first-of-type'>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_commune.php?periode=day'>Journ&eacute;e</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_commune.php?periode=first'>Premi&egrave;re quinzaine</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_commune.php?periode=second'>Deuxi&egrave;me quinzaine</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_commune.php?periode=month'>Mois</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_commune.php?periode=all'>Complet</a></li>";
		echo "							</ul>";
		echo "						</div>";
		echo "					</div>";
		echo "				</li>";
    ...
    <div id="top">
		...
		<h1>
 			Perte des tickets mod&eacute;rateurs : <?=$listingTitle?>
		</h1>
				...
				<div class="View">
					...
					<div class="navigation-hight">
						...
						<div class="navigation-calendar">
							...
							<a class="previousMajor" href="./erreur_commune.php?action=previous_month" onclick="" title="Mois pr&eacute;c&eacute;dent"></a>
							<a class="previousMinor" href="./erreur_commune.php?action=previous_day" onclick="" title="Jour pr&eacute;c&eacute;dent"></a>
							<a class="nextMajor" href="./erreur_commune.php?action=next_month" onclick="" title="Mois suivant"></a>
							<a class="nextMinor" href="./erreur_commune.php?action=next_day" onclick="" title="Jour suivant"></a>
