<?php 
	...
	$nom_fichier = "erreur_medecin.php";
	...
	$listingTitle = "";
	$sqlglobal= "select ta.id as id, DATE_FORMAT(ta.date, GET_FORMAT(DATE, 'EUR')) as tarification_date, pa.nom as patient_nom, pa.prenom as patient_prenom, me.nom as medecin_nom, me.prenom as medecin_prenom, er.a_payer as a_payer  FROM erreurs er, patients pa, medecins me, tarifications ta WHERE er.type = 'erreur_medecin' AND ta.medecin_inami = me.inami and ta.patient_id = pa.id and er.tarification_id = ta.id";
	
	switch($periode) {
		case 'day':
			$sqlglobal .= " and ta.date like '".$annee."-".$mois."-".$jour."%'";
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_medecin.php?id=day";
		...
		case 'first':
			...
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_medecin.php?id=first";
		...
		case 'second':
			...
			$sqlglobal .= " and ta.date >= '".$annee."-".$mois."-16'";
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_medecin.php?id=second";
		...
		case 'month':
			...
			$sqlglobal .= " and ta.date >= '".$annee."-".$mois."-01'";
			$sqlglobal .= " order by ta.date";
			$impression_url = "../factures/print_erreur_medecin.php?id=month";
			$listingTitle .= " Mois";
		break;
		case 'all':
			$sqlglobal .= " order by ta.date";
...
<body id='body'>
   ...
   <?php
		...
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_medecin.php?periode=day'>Journ&eacute;e</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_medecin.php?periode=first'>Premi&egrave;re quinzaine</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_medecin.php?periode=second'>Deuxi&egrave;me quinzaine</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_medecin.php?periode=month'>Mois</a></li>";
		echo "                          	<li class='yuimenuitem'><a class='yuimenuitemlabel' href='erreur_medecin.php?periode=all'>Complet</a></li>";
		echo "							</ul>";
		echo "						</div>";
		echo "					</div>";
		echo "				</li>";
    ...
    <div id="top">
		...
		<h1>
 			Erreurs dues aux m&eacute;decins : <?=$listingTitle?>
		</h1>
	  	...
	  	<div id="main">
			...
			<div id="tab_panel">
				...
				<div class="secondary_tabs">
    				...
    				<span>Erreurs des m&eacute;decins</span> 
				...
				<div class="View">
					...
					<div class="navigation-hight">
						...
						<div class="navigation-calendar">
							...
							<a class="previousMajor" href="./erreur_medecin.php?action=previous_month" onclick="" title="Mois pr&eacute;c&eacute;dent"></a>
							<a class="previousMinor" href="./erreur_medecin.php?action=previous_day" onclick="" title="Jour pr&eacute;c&eacute;dent"></a>
							<a class="nextMajor" href="./erreur_medecin.php?action=next_month" onclick="" title="Mois suivant"></a>
							<a class="nextMinor" href="./erreur_medecin.php?action=next_day" onclick="" title="Jour suivant"></a>
