			...
			<div id="tab_panel">
				...
				<div class="listViewPane">
					...
					<div class="navigation-hight">
						...
						<div id='formhelp'>
							Ce formulaire permet de rechercher et de modifier un acte &agrave; condition que celui-ci existe d&eacute;j&agrave; dans l'application. Il est également possible de supprimer un acte erroné.<br />
						</div>
						<div id='formmodif'>
						</div>
