<?php 
	...
	if ($actionModifActe == 1) {
		...
		if ($test->Count == 0) {
			...
			$sql= "UPDATE actes set code='$formCode', description='$formDescription', cecodis='$formCecodis', cout_vp='$formCoutVP', cout_tr='$formCoutTR' , cout_tp='$formCoutTP', length='$formLength' where id = '$formID'";
