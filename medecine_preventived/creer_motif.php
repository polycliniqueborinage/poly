						...
						<fieldset class=''>
							<legend>Description du motif</legend>
								<table ID="motif" border='1' cellspacing='0' cellpadding='0'>
									...
									<!-- Criteres -->
									<tr>
										<th class='<?=$test->fieldError("requete","required")?>'>Requête pour la s&eacute;lection</th>
										<td><b>
											<a onclick="window.open('./creer_criteres.php'); ">G&eacute;rer les crit&egrave;res sur les tables s&eacute;lectionn&eacute;e</a>
											</b>
											<br>
